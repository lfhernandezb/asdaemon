...
CREATE  TABLE IF NOT EXISTS `amigo_seguro`.`usuario` (
  ...
  `hombre` BIT(1) NOT NULL DEFAULT b'1' ,
  `contactar_contactos_de_contactos` BIT(1) NOT NULL DEFAULT b'0' ,
  `contactar_desconocidos` BIT(1) NOT NULL DEFAULT b'0' ,
  `publicar_informacion` BIT(1) NOT NULL DEFAULT b'0' ,
